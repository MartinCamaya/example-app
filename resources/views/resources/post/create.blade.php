    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('post.create') }}">{{__('New Post')}}</a></li>
            </ol>
        </nav>
    </div>
    <!-- End Page Title -->
                        ...
                        <form action="{{ route('post.store') }}" method="post">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="w-100 mt-5">
                                    <button type="submit" class="btn btn-primary w-100" style="background-color:maroon; color:gold;">Save Post</button>
                                </div>
                            </div>
